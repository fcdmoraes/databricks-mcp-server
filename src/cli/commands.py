...
from src.server.databricks_mcp_server import main as server_main
from src.server.databricks_mcp_server import mcp
...
def show_version() -> None:
    ...
    print(f"\nDatabricks MCP Server v{settings.VERSION}")
